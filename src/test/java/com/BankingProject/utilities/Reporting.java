...
public class Reporting extends TestListenerAdapter{ //TestListenerAdapter is a predefined class
	
	public ExtentHtmlReporter htmlReporter;
	public ExtentReports extent;  // used to specify location of the report    
